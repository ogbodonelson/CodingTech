...
if($username == 'Lino' || $username == 'Oscar Ogbodo' || $username == 'Nelson Ogbodo' ||  $username == 'Lydia' ||  $username == 'Favour'){
  $display = "visible";
}else{
  $display = "none";
}
      ...
      <ul class="navbar-nav">
        ...
        <li>
          ...
          <div class="btn-group mx-3">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="./editor/html/popular/full.php">Create</a></li>
            </ul>
          </div>
        ...
        <li class="nav-item" style="display: <?php echo $display ?>">
          <a class="nav-link text-white " href="./pages/sign-up.php">
            ...
            <span class="nav-link-text ms-1">Register User</span>
          </a>
        </li>
        <li class="nav-item">
